...
# i would like to make a check, if let's say truck has enough capacity for only one more city: is it better to go back now and refill later, or go to the next city and then go back to depot
