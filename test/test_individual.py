...
import cvpr_metaheuristics.problem.individual as individual
from cvpr_metaheuristics.problem.individual import Individual


class TestIndividual(TestCase):

    @patch('cvpr_metaheuristics.problem.individual.generate_two_random_indexes')
    ...
    @patch('cvpr_metaheuristics.problem.individual.cost')
